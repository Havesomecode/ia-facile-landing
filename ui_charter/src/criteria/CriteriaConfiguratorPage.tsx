  ...
  return (
    <main className="configurator-shell">
      <section className="configurator-intro">
        <div>
          <p className="configurator-kicker">Storybook-controlled preview</p>
          <h1>Landing page steerable by criterion</h1>
          <p className="configurator-lead">
            The preview stays clean. Use Storybook controls to change each criterion and compare the effect on the IA
            Facile landing page.
          </p>
        </div>
        <div className="configurator-status">
          <p className="configurator-kicker">Current mix</p>
          <strong>{activePreset?.title ?? 'Custom mix'}</strong>
          <p>{activePreset?.summary ?? 'Manual combination driven from Storybook controls.'}</p>
        </div>
      </section>
